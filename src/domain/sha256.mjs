// @ts-nocheck -- self-contained FIPS 180-4 SHA-256; correctness is pinned by
// known-answer vectors in sha256.test.mjs. Kept dependency-free so the domain
// layer runs identically in Node and the browser (no `node:crypto`).
