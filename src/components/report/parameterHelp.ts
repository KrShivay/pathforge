const PARAMETER_HELP: Record<string, string> = {
  ...
  neutrophils: "The proportion of polymorph white blood cells.",
  lymphocytes: "The proportion of lymphocytes among white blood cells.",
  monocytes: "The proportion of monocytes among white blood cells.",
  eosinophils: "The proportion of eosinophils among white blood cells.",
  basophils: "The proportion of basophils among white blood cells.",
  ...
  "widal-interpretation": "The overall interpretation of the Widal screening result.",
  "blood-sugar-fasting": "Blood glucose measured after fasting.",
  "blood-sugar-postprandial": "Blood glucose measured after a meal.",
  "blood-sugar-random": "Blood glucose measured at any time, without regard to meals.",
  "blood-sugar-random-standalone": "Blood glucose measured at any time, without regard to meals.",
  "serum-bilirubin-total": "The total bilirubin level in serum.",
  "serum-bilirubin-direct": "The direct bilirubin level in serum.",
  "serum-bilirubin-indirect": "The indirect bilirubin level in serum.",
  "serum-uric-acid-value": "The uric acid level measured in serum.",
  "hemoglobin-screen-value": "The oxygen-carrying hemoglobin measured in whole blood.",
  "sputum-afb-result": "The sputum test result for acid-fast bacilli.",
  "mantoux-ppd-dose": "The PPD 10 TU/ID Mantoux skin test and 72-hour dermal reaction.",
  "mantoux-dose": "The stated PPD dose used for the Mantoux test.",
  "mantoux-route": "The route used to administer the Mantoux test dose.",
  "mantoux-time": "The stated reading time for the Mantoux test.",
  "mantoux-induration": "The measured horizontal diameter of the Mantoux induration.",
  "mantoux-remark": "The reported Mantoux test interpretation.",
  "mantoux-interpretation-notes": "Threshold notes used to interpret Mantoux induration by risk group.",
  "rheumatoid-factor-result": "The qualitative rheumatoid arthritis factor result.",
  "serochek-mtb-igg": "The Serochek-MTB IgG antibody result.",
  "serochek-mtb-igm": "The Serochek-MTB IgM antibody result.",
  "signal-mf-result": "The Signal-MF microfilaria test result.",
  "signal-tp-vdrl-result": "The Signal-TP VDRL syphilis test result.",
  "chest-mediastinum": "The chest radiograph appearance of the mediastinum.",
  "chest-hilar-lymph-nodes": "The chest radiograph appearance of hilar lymph nodes.",
  "chest-lungs-right": "The chest radiograph finding for the right lung field.",
  "chest-lungs-left": "The chest radiograph finding for the left lung field.",
  "chest-heart-shadow": "The chest radiograph appearance of the heart shadow.",
  "chest-costophrenic-right": "The right costophrenic angle finding.",
  "chest-costophrenic-left": "The left costophrenic angle finding.",
  "chest-diaphragm-right": "The right diaphragm finding.",
  "chest-diaphragm-left": "The left diaphragm finding.",
  "chest-ribs-right": "The right rib finding.",
  "chest-ribs-left": "The left rib finding.",
  "chest-impression": "The overall impression of the chest radiograph.",
};
