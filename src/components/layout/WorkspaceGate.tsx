...
const GATE_CONTENT = {
  entry: {
    ...
    copy: "Enter the local workspace to start your pathology report workflow.",
  ...
  locked: {
    ...
    copy: "Report work is paused while the workspace is locked. Unlock to return to your local report workflow.",
