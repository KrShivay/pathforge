...
- This prototype does not implement enterprise permissions, user roles, identity providers, approval flows, or audit-based authorization gating. See [SCOPE.md](SCOPE.md) and [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
...
This project is indexed by GitNexus as **pathforge** (1238 symbols, 2737 relationships, 78 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/pathforge/context` | Codebase overview, check index freshness |
| `gitnexus://repo/pathforge/clusters` | All functional areas |
| `gitnexus://repo/pathforge/processes` | All execution flows |
| `gitnexus://repo/pathforge/process/{name}` | Step-by-step execution trace |
